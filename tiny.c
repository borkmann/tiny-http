...
int open_listenfd(int port){
    ...
    if (setsockopt(listenfd, SOL_IP, IP_TRANSPARENT, (const char*)&one, sizeof(one)) < 0)
        return -1;
    ...
    serveraddr.sin_addr.s_addr = htonl(/*INADDR_ANY*/ 0x01010101);
